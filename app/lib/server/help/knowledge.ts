...
export const HELP_KB = [
  ...
  "CLAIM A HANDLE: go to the handle page to pick a public handle so friends can find you. Optional for earning, but nice for the social side.",
  "DO THE THING: create a challenge (dare a friend, or a parent paying a kid) from the new-challenge page, or join a sponsor pool from the pools page. Creating a challenge creates a pool.",
